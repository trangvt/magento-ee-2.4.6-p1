...
use Magento\PurchaseOrder\Model\Notification\Email\ContentSource\ApprovalAndPaymentDetailsRequiredAction;
 ...
 */
class ApprovalAndPaymentDetailsRequiredActionPlugin
{
    /**
     ...
     * @param AddingApproverRolesProcessor|null $addingApproverRolesProcessor
     */
    public function __construct(
        ...
        AddingApproverRolesProcessor $addingApproverRolesProcessor = null
    ) {
     ...
     *
     * @param ApprovalAndPaymentDetailsRequiredAction $subject
     * @param DataObject $result
     * @return DataObject
     * @throws LocalizedException
     * @SuppressWarnings(PHPMD.UnusedFormalParameter)
     */
    public function afterGetTemplateVars(
        ApprovalAndPaymentDetailsRequiredAction $subject,
        DataObject $result
    ): DataObject {
