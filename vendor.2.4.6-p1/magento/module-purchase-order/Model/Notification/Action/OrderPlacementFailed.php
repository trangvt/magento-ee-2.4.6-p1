...
use Magento\PurchaseOrder\Model\Notification\Email\ContentSource\OrderPlacementFailedAction;
use Magento\PurchaseOrder\Model\Notification\SenderInterface;

/**
 * Action to notify that purchase order failed to be converted to order.
 */
class OrderPlacementFailed implements ActionNotificationInterface
{
    /**
    ...
    /**
     * Failed to place order constructor.
     *
    ...
    public function __construct(
        ...
        string $contentSourceType = OrderPlacementFailedAction::class
    ) {
