...
use Magento\PurchaseOrder\Model\Notification\Email\ContentSource\AutoApprovePendingPaymentAction;
...
/**
 * Action to notify that purchase order is placed and pending payment.
 */
class AutoApprovedPendingPayment implements ActionNotificationInterface
{
    /**
    ...
    /**
     * AutoApprovedPendingPayment constructor.
    ...
    public function __construct(
        ...
        string $contentSourceType = AutoApprovePendingPaymentAction::class
    ) {
