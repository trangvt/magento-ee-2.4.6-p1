...
/**
 * Action to notify that approval and payment details are required for purchase order with online payment method.
 */
class ApprovalAndPaymentDetailsRequired implements ActionNotificationInterface
{
    /**
    ...
    /**
     * ApprovalAndPaymentDetailsRequired constructor.
    ...
    public function __construct(
        ...
        string $contentSourceType = ApprovalAndPaymentDetailsRequiredAction::class
    ) {
