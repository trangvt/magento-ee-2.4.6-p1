...
use Magento\PurchaseOrder\Model\Notification\Email\ContentSource\AutoApproveAction;
...
/**
 * Action to notify that purchase order is placed.
 */
class AutoApproved implements ActionNotificationInterface
{
    /**
    ...
    public function __construct(
        ...
        string $contentSourceType = AutoApproveAction::class
    ) {
