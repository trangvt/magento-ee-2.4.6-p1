...
class RoleManagement implements \Magento\Company\Api\RoleManagementInterface
{
     ...
     * @var int
     */
    private $companyManagerRoleId = PHP_INT_MAX;

    /**
     * @var string
     */
    private $companyManagerRoleName = 'Purchaser\'s Manager';
     ...
     * @return int
     */
    public function getCompanyManagerRoleId()
    {
        return $this->companyManagerRoleId;
    }
    ...
    /**
     * Get company manager role name.
     *
     * @return string
     */
    public function getCompanyManagerRoleName()
    {
        return $this->companyManagerRoleName;
    }
    ...
    {
        if ($this->companyManagerRole === null) {
            $this->companyManagerRole = $this->roleFactory->create();
            $this->companyManagerRole->setId($this->getCompanyManagerRoleId());
            $roleName = __($this->getCompanyManagerRoleName());
            $this->companyManagerRole->setRoleName($roleName);
        }

        return $this->companyManagerRole;
    }
}
