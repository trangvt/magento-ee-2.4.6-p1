...
class CompanyProfileTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->userFactory = $this->createPartialMock(UserFactory::class, ['create']);
        $this->messageManager = $this->getMockForAbstractClass(ManagerInterface::class);
        $this->companyAdminPermission = $this->createMock(CompanyAdminPermission::class);
        $this->customerRepository = $this->getMockForAbstractClass(CustomerRepositoryInterface::class);
        $this->customerViewHelper = $this->getMockForAbstractClass(CustomerNameGenerationInterface::class);
        $this->company = $this->getMockForAbstractClass(CompanyInterface::class);
        $this->company->expects($this->any())->method('getId')->willReturn(1);
        $this->companyAdmin = $this->getMockForAbstractClass(CustomerInterface::class);
        $this->salesRepresentative = $this->createMock(User::class);
    ...
    {
        $messageCollection = $this->createMock(Collection::class);
        $firstMessage = $this->getMockForAbstractClass(MessageInterface::class);
        $firstMessage->expects($this->any())->method('getText')->willReturn('Error Message 1');
        $secondMessage = $this->getMockForAbstractClass(MessageInterface::class);
        ...
        $messageCollection->expects($this->any())->method('getItems')->willReturn($iterator);
    ...
    public function testGetCompanyJobTitle(array $companyAdminData, $jobTitle)
    {
        ...
        $companyExtensionAttributes = $this->createMock(Customer::class);
        $companyExtensionAttributes->expects($this->any())->method('getJobTitle')->willReturn($jobTitle);
        $extensionAttributes = $this->getMockBuilder(CustomerExtension::class)
