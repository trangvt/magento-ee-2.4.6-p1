...
class StructureTest extends TestCase
{
    ...
    /**
     * @var StructureSearchResultsInterface|MockObject
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->teamRepositoryInterface = $this->getMockBuilder(TeamRepositoryInterface::class)
            ->disableOriginalConstructor()
            ->getMockForAbstractClass();
        $companyCustomerCollectionFactory = $this->getMockBuilder(TeamCollectionFactory::class)
            ->disableOriginalConstructor()
            ->getMock();
        $this->sourceNodeMock = $this->getMockBuilder(Node::class)
            ->disableOriginalConstructor()
            ->getMock();
        $this->targetNodeMock = $this->getMockBuilder(Node::class)
            ->disableOriginalConstructor()
            ->getMock();
        $this->sourceChildNodeMock = $this->getMockBuilder(Node::class)
            ->disableOriginalConstructor()
            ->getMock();
     ...
     * @return void
     */
    public function testMoveCustomerStructure(): void
    {
        $sourceCustomerId = 1;
        $targetCustomerId = 2;
        $totalCount = 1;
        ...
        $sourceStructure = $this->getMockBuilder(Structure::class)
            ->disableOriginalConstructor()
            ->getMock();
        $targetStructure = $this->getMockBuilder(Structure::class)
            ->disableOriginalConstructor()
            ->getMock();
        $sourceStructure->method('getId')
            ->willReturn($sourceCustomerId);
        $targetStructure->method('getId')
            ->willReturn($targetCustomerId);

        $this->structureList->expects($this->exactly(5))
            ->method('getItems')
        ...
        $this->structureList->method('getTotalCount')
            ->willReturn($totalCount);
        $this->structureRepository->method('getList')
            ->willReturn($this->structureList);
        $this->getSearchCriteria();

        $sourceStructure->method('getData')
            ->with('path')
            ->willReturn($testParentNode);
     ...
     * @return void
     */
    public function testMoveCustomerStructureKeepOld(): void
    {
        $sourceCustomerId = 1;
        $targetCustomerId = 2;
        $totalCount = 1;
        ...
        $this->tree->method('loadNode')
            ->willReturn($this->sourceNodeMock);
        $this->sourceNodeMock->method('loadChildren')
            ->willReturnSelf();
    ...
    {
        $group = $this->getMockBuilder(FilterGroup::class)
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $sort = $this->getMockBuilder(SortOrder::class)
            ->disableOriginalConstructor()
            ->getMock();
