...
class NegotiableQuoteManagement implements NegotiableQuoteManagementInterface
{
    ...
    private function updateSnapshotQuoteStatus($quoteId, $status)
    {
        $quote = $this->quoteRepository->get($quoteId, ['*']);
        $negotiableQuote = $quote->getExtensionAttributes()->getNegotiableQuote();
        $snapshot = $negotiableQuote->getSnapshot() ? json_decode($negotiableQuote->getSnapshot(), true) : [];
    ...
    public function getSnapshotQuote($quoteId)
    {
        ...
        $snapshot = is_string($negotiableQuote->getSnapshot()) ?
            json_decode($negotiableQuote->getSnapshot(), true) : null;
