...
class Sender implements \Magento\NegotiableQuote\Model\EmailSenderInterface
{
     ...
     */
    public const XML_PATH_QUOTE_EMAIL_NOTIFICATIONS_ENABLED = 'sales_email/quote/enabled';
    public const XML_PATH_QUOTE_EMAIL_NOTIFICATIONS_COPY_METHOD = 'sales_email/quote/copy_method';
    public const XML_PATH_QUOTE_EMAIL_NOTIFICATIONS_COPY_TO = 'sales_email/quote/copy_to';
    public const XML_PATH_SELLER_NEW_QUOTE_CREATED_BY_BUYER_TEMPLATE = 'sales_email/quote/new_seller_template';
    public const XML_PATH_SELLER_QUOTE_UPDATED_BY_BUYER_TEMPLATE = 'sales_email/quote/updated_seller_template';
    public const XML_PATH_BUYER_QUOTE_DECLINED_BY_SELLER_TEMPLATE = 'sales_email/quote/declined_buyer_template';
    public const XML_PATH_BUYER_QUOTE_UPDATED_BY_SELLER_TEMPLATE = 'sales_email/quote/updated_buyer_template';
    /**#@-*/
    ...
    private function getCopyEmailAddresses($storeId)
    {
        ...
        $emailCopyAddress = ($emailCopyAddress !== null) ? trim($emailCopyAddress) : '';
        if ($emailCopyAddress !== '') {
            $arrayOfAddresses = explode(',', $emailCopyAddress);
            return array_map('trim', $arrayOfAddresses);
        }
        return [];
    }
}
