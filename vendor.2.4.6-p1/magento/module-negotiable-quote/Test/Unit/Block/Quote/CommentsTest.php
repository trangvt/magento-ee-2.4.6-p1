...
use Magento\NegotiableQuote\Block\Quote\Comments;
...
class CommentsTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->creator = $this->getMockBuilder(Creator::class)
            ->disableOriginalConstructor()
            ->getMock();
        $this->negotiableQuoteConfig = $this->getMockBuilder(Config::class)
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $this->assertInstanceOf(Quote::class, $this->comments->getQuoteHelper());
    }
     ...
     * @param DataObject|null $draftComment
    ...
    public function testGetCommentCreator()
    {
        ...
        /**
         * @var CommentInterface|MockObject $comment
         */
