...
class HistoryTest extends TestCase
{
    ...
    /**
     * @var LogCommentsInformation|MockObject
     */
    private $historyLogCommentsInformation;

    /**
     * @var LogInformation|MockObject
     */
    private $historyLogInformation;

    /**
     * @var LogProductInformation|MockObject
     */
    ...
    {
        $historyMock = $this->getMockBuilder(HistoryInterface::class)
            ->disableOriginalConstructor()
            ->getMockForAbstractClass();
