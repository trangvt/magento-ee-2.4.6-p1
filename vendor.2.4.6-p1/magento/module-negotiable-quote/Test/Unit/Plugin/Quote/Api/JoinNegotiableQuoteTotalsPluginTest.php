...
use Magento\NegotiableQuote\Plugin\Quote\Api\JoinNegotiableQuoteTotalsPlugin;
 ...
 */
class JoinNegotiableQuoteTotalsPluginTest extends TestCase
{
    /**
    ...
    /**
     * @var NegotiableQuoteTotalsInterfaceFactory|MockObject
     */
    private $negotiableQuoteTotalsFactory;

    /**
     * @var TotalsItemExtensionFactory|MockObject
     */
    private $totalsItemExtensionFactory;

    /**
     * @var NegotiableQuoteItemTotalsInterfaceFactory|MockObject
     */
    ...
    /**
     * @var JoinNegotiableQuoteTotalsPlugin
     */
    private $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->negotiableQuoteTotalsFactory = $this->getMockBuilder(
            NegotiableQuoteTotalsInterfaceFactory::class
        )
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        $this->totalsItemExtensionFactory = $this->getMockBuilder(
            TotalsItemExtensionFactory::class
        )
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        $this->negotiableQuoteItemTotalsFactory = $this->getMockBuilder(
            NegotiableQuoteItemTotalsInterfaceFactory::class
        )
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        ...
        $this->plugin = $objectManager->getObject(
            JoinNegotiableQuoteTotalsPlugin::class,
            [
    ...
    public function testAfterGet()
    {
        ...
        $subject = $this->getMockBuilder(CartTotalRepositoryInterface::class)
            ->disableOriginalConstructor()
            ->getMockForAbstractClass();
        $result = $this->getMockBuilder(TotalsInterface::class)
            ->disableOriginalConstructor()
            ->getMockForAbstractClass();
        ...
        $negotiableQuote = $this->getMockBuilder(NegotiableQuoteInterface::class)
            ->disableOriginalConstructor()
            ->getMockForAbstractClass();
        $totalsExtension = $this->getMockBuilder(TotalsExtension::class)
            ->disableOriginalConstructor()
            ->getMock();
        $totalsItemExtension = $this->getMockBuilder(
            TotalsItemExtension::class
        )
            ->disableOriginalConstructor()
            ->getMock();
        $totalsItem = $this->getMockBuilder(TotalsItemInterface::class)
            ->disableOriginalConstructor()
            ->getMockForAbstractClass();
        ...
        $negotiableQuoteTotals = $this->getMockBuilder(
            NegotiableQuoteTotalsInterface::class
        )
            ->disableOriginalConstructor()
            ->getMockForAbstractClass();
        $totalsExtensionAttributes = $this->getMockBuilder(TotalsExtensionInterface::class)
            ->disableOriginalConstructor()
        ...
        $cartItem = $this->getMockBuilder(CartItemInterface::class)
            ->disableOriginalConstructor()
            ->getMockForAbstractClass();
        $cartItemExtension = $this->getMockBuilder(CartItemExtensionInterface::class)
            ->disableOriginalConstructor()
        ...
        $negotiableQuoteItemTotals = $this->getMockBuilder(
            NegotiableQuoteItemTotalsInterface::class
        )
            ->disableOriginalConstructor()
            ->getMockForAbstractClass();
        $totalsItemExtensionInterface =$this->getMockBuilder(
            TotalsItemExtensionInterface::class
        )
            ->disableOriginalConstructor()
