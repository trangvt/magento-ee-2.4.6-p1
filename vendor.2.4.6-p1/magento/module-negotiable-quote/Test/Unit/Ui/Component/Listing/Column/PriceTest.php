...
use Magento\NegotiableQuote\Ui\Component\Listing\Column\Price;
...
class PriceTest extends ColumnTest
{
     ...
     * @var string
     */
    protected $className = Price::class;
    ...
    protected function setUpPrepareArguments(array $arguments)
    {
        ...
        $priceFormatter = $this->getMockBuilder(PriceCurrencyInterface::class)
            ->disableOriginalConstructor()
            ->getMockForAbstractClass();
