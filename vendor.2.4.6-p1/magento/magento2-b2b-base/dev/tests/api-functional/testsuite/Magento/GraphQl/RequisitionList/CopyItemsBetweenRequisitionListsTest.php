...
/**
 * Test coverage for copying items between requisition list
 */
class CopyItemsBetweenRequisitionListsTest extends GraphQlAbstract
{
    /**
    ...
    public function testCopyItems(): void
    {
        ...
        $this->assertArrayHasKey('copyItemsBetweenRequisitionLists', $response);
        $this->assertArrayHasKey('requisition_list', $response['copyItemsBetweenRequisitionLists']);
        $requisitionListResponse = $response['copyItemsBetweenRequisitionLists']['requisition_list'];
     ...
     * @magentoApiDataFixture Magento/RequisitionList/_files/list_with_id_two.php
     */
    public function testCopyItemFromGuestRequisitionList(): void
    {
     ...
     * @magentoApiDataFixture Magento/RequisitionList/_files/list_items_v2_for_list_two.php
     */
    public function testCopyItemFromAnotherCustomerRequisitionList(): void
    {
        $this->expectException(Exception::class);
        $this->expectExceptionMessage("The current user cannot perform operations on requisition list");
        ...
        $this->graphQlMutation(
            ...
            [],
            '',
            $this->getHeaderAuthentication('customer2@example.com', 'password')
        );
    }
     ...
     */
    public function testWithoutRequiredRequisitionItemIdParameter(): void
    {
        $this->expectException(Exception::class);
        $this->expectExceptionMessage('No such item(s) with ID(s) ""');
     ...
     * @magentoApiDataFixture Magento/RequisitionList/_files/list_with_id_two.php
     */
    public function testCopyItemFromNonExistentSourceRequisitionList(): void
    {
        $this->expectException(Exception::class);
     ...
     * @magentoApiDataFixture Magento/RequisitionList/_files/list_with_id.php
     */
    public function testCopyItemToNonExistentRequisitionList(): void
    {
        $this->expectException(Exception::class);
        $this->expectExceptionMessage("No such entity with id = 999");

        $sourceRequisitionListId = $this->getRequisitionList->execute('Test - Requisition List');
        $destinationRequisitionListId = 999;
        $itemId = $this->getRequisitionListItemId->execute('list two', 'item_1');
     ...
     * @magentoApiDataFixture Magento/RequisitionList/_files/list_with_id_two.php
     */
    public function testCopyNonExistentItem(): void
    {
        $this->expectException(Exception::class);
        $this->expectExceptionMessage('No such item(s) with ID(s) "999"');
