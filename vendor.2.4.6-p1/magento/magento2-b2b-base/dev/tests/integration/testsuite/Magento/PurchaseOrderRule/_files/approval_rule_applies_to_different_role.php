...
/** @var Role $role */
$appliesToRole = $objectManager->create(RoleInterface::class);
$appliesToRole->setCompanyId($company->getId());
$appliesToRole->setRoleName('Applies To Role');
/** @var RoleRepositoryInterface $roleRepository */
$roleRepository = $objectManager->get(RoleRepositoryInterface::class);
$roleRepository->save($appliesToRole);
...
$rule->setAppliesToRoleIds([$appliesToRole->getId()]);
