...
namespace Magento\RequisitionList\Controller\Adminhtml\System;
...
class ConfigTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
     ...
     * @var string
     */
    protected $resource = 'Magento_RequisitionList::config_requisitionlist';
     ...
     * @var string
     */
    protected $uri = 'backend/admin/system_config/edit/section/requisitionlist';
    ...
    public function testEditAction()
    {
        ...
        $this->assertMatchesRegularExpression(
            '/class="admin__page-nav-link item-nav">\s*<span>Requisition Lists<\/span>/',
