...
$quoteIdMask->setMaskedId('nq_customer_declined_mask');
...
//$negotiableQuote->setStatus(\Magento\NegotiableQuote\Api\Data\NegotiableQuoteInterface::STATUS_PROCESSING_BY_ADMIN);
$negotiableQuote->setStatus(\Magento\NegotiableQuote\Api\Data\NegotiableQuoteInterface::STATUS_DECLINED);
$quoteRepository->save($quote);
