...
$objectManager->get(\Magento\Framework\Registry::class)->unregister('Magento/NegotiableQuote/_file/discount_10percent');
$objectManager->get(\Magento\Framework\Registry::class)
    ->register('Magento/NegotiableQuote/_file/discount_10percent', $salesRule->getRuleId());
