...
$quoteAddressFactory = Bootstrap::getObjectManager()->create(
...
$shippingAddress = $quote->getShippingAddress()->importCustomerAddressData($quoteAddress->getDataModel());
$shippingAddress->save();

$shippingMethodManagement = Bootstrap::getObjectManager()->create(
    \Magento\Quote\Model\ShippingMethodManagement::class
);
$shippingMethodManagement->set($quoteId, 'flatrate', 'flatrate');
