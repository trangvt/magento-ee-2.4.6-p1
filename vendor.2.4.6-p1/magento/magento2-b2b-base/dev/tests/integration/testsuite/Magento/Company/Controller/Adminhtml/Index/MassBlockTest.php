...
class MassBlockTest extends AbstractBackendController
{
    ...
    /**
     * Test backoffice admin has access to /company/index/massBlock when granted Magento_Company::manage permission
     *
     * Given a backoffice admin
     * When Magento_Company::manage ACL permission is allowed for the admin's role
     * And a POST request is made to set multiple companies' statuses to BLOCKED directly from the company listing page
    ...
    /**
     * Test backoffice admin does not have access to /company/index/massBlock when denied Magento_Company::manage
     * permission
     *
     * Given a backoffice admin
